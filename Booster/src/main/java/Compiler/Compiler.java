            ...
            if (Config.REGRESSION_MODE) {
                ...
                if (testNameToFailMap.containsKey(testCase.getSimpleName())) { // add try catch fail
                    ...
                    if (failAddedMethodAndStringPair != null) {
                        ...
                        // System.out.println("WARNING: no try catch fail is added for " + testCase.getSimpleName());
                    }
                    ...
                    if (assertionAdded != null) {
                        ...
                        // System.out.println("WARNING: no assertion is added for " + testCase.getSimpleName());
                    }
                }
            } else {
    ...
    public static void updatePoolWithNewTest(Set<MUTInput> mutInputs, MUTInput mutInput, CtMethod testCase) {
        ...
        if (mut != null) {
            ...
            if (ASTParser.isLocalVariable(lastStatement)) {
                ...
                List<CtLocalVariable> localVariablesClone = lastStatementClone.getElements(new TypeFilter<>(CtLocalVariable.class));
                ...
                breakPoint:
                for(MUTInput mutInputPool:mutInputs){
                    int argCounter = 0;
